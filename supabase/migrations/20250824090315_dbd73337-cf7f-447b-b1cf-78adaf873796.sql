-- Insert sample data for the salon management system with proper type casting
...
('Sarah Johnson', 'sarah.johnson@email.com', '+1-555-0123', 'Curly', 'Long layers with face-framing', 'Prefers natural styling products', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Maria Rodriguez', 'maria.rodriguez@email.com', '+1-555-0234', 'Straight', 'Bob cut', 'Allergic to sulfates', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Jennifer Chen', 'jenny.chen@email.com', '+1-555-0345', 'Wavy', 'Pixie cut', 'Regular customer - monthly appointments', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Emily Davis', 'emily.davis@email.com', '+1-555-0456', 'Thick', 'Shoulder length', 'Color treatment specialist needed', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Amanda Wilson', 'amanda.wilson@email.com', '+1-555-0567', 'Fine', 'Layered cut', 'Prefers eco-friendly products', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid);
...
('Jessica Martinez', 'jessica@salon.com', '+1-555-1001', 'Senior Hair Stylist', 4500.00, 'paid', '2023-01-15'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Michael Brown', 'michael@salon.com', '+1-555-1002', 'Hair Stylist', 3800.00, 'paid', '2023-03-20'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Lisa Garcia', 'lisa@salon.com', '+1-555-1003', 'Color Specialist', 4200.00, 'pending', '2023-06-10'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('David Thompson', 'david@salon.com', '+1-555-1004', 'Receptionist', 2800.00, 'paid', '2023-02-01'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Rachel Kim', 'rachel@salon.com', '+1-555-1005', 'Junior Stylist', 3200.00, 'pending', '2023-09-15'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Carlos Rodriguez', 'carlos@salon.com', '+1-555-1006', 'Barber', 3500.00, 'overdue', '2023-04-05'::date, 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid);

-- Insert inventory categories
INSERT INTO public.inventory_categories (name, description, created_by) VALUES
('Hair Care Products', 'Shampoos, conditioners, and hair treatments', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Styling Products', 'Gels, mousses, sprays, and styling tools', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Color & Chemicals', 'Hair dyes, bleaches, and chemical treatments', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Tools & Equipment', 'Scissors, combs, brushes, and electrical tools', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid),
('Salon Supplies', 'Towels, capes, foils, and general supplies', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid);

-- Insert sample inventory items with proper date and UUID casting
...
SELECT 
  ...
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid
UNION ALL SELECT
...
SELECT 
  i.id, 'in', 25, i.unit_price, (25 * i.unit_price), 'Initial stock purchase', 'PO-2024-001', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid
FROM public.inventory_items i 
WHERE i.name = 'Professional Shampoo - 1L'
UNION ALL SELECT
  i.id, 'out', 10, i.unit_price, (10 * i.unit_price), 'Used for customer services', 'USAGE-001', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid
FROM public.inventory_items i 
WHERE i.name = 'Professional Shampoo - 1L'
UNION ALL SELECT
  i.id, 'in', 15, i.unit_price, (15 * i.unit_price), 'Restock order', 'PO-2024-002', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid
FROM public.inventory_items i 
WHERE i.name = 'Hair Styling Gel - 250ml'
UNION ALL SELECT
  i.id, 'out', 2, i.unit_price, (2 * i.unit_price), 'Color service for customer', 'SERVICE-001', 'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'::uuid
FROM public.inventory_items i 

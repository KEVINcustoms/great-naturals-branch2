...
SELECT 
  'Professional Shampoo - 1L', 15, 20, 50, 24.99, '2025-12-31', 'Beauty Supply Co', '123456789012',
  (SELECT id FROM public.inventory_categories WHERE name = 'Hair Care Products' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
  'Moisturizing Conditioner - 1L', 8, 15, 40, 28.50, '2025-10-15', 'Beauty Supply Co', '123456789013',
  (SELECT id FROM public.inventory_categories WHERE name = 'Hair Care Products' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
  'Hair Styling Gel - 250ml', 25, 10, 60, 12.75, '2026-03-20', 'Style Pro Inc', '123456789014',
  (SELECT id FROM public.inventory_categories WHERE name = 'Styling Products' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
  'Hair Spray - Strong Hold', 18, 12, 36, 15.99, '2026-08-10', 'Style Pro Inc', '123456789015',
  (SELECT id FROM public.inventory_categories WHERE name = 'Styling Products' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
  'Hair Dye - Dark Brown', 5, 8, 25, 18.50, '2025-06-30', 'Color Master Ltd', '123456789016',
  (SELECT id FROM public.inventory_categories WHERE name = 'Color & Chemicals' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
  'Bleach Powder - 500g', 3, 6, 20, 22.00, '2025-09-15', 'Color Master Ltd', '123456789017',
  (SELECT id FROM public.inventory_categories WHERE name = 'Color & Chemicals' LIMIT 1),
  'df16f66a-13d4-4475-b5e0-4eff03ec1a4b'
UNION ALL SELECT
